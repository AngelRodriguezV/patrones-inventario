...
public class Venta implements Serializable {
    ...
    @JoinColumn(name = "folio", referencedColumnName = "idnota")
    @ManyToOne
    private Nota folio;
    @JoinColumn(name = "idProducto", referencedColumnName = "idprod")
    @ManyToOne
    ...
    public Nota getFolio() {
        return folio;
    }

    public void setFolio(Nota folio) {
        this.folio = folio;
    }
